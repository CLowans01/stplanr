...
# Omagh2 <- st_transform(Omagh , "EPSG:4326")
# plot(Omagh2)
...
# extract from od_inter only those codes that are present in Omagh shp file - nb this ought to be redundant due to the input data but is done anyway to play it safe
OD_Omagh <- od_inter %>%
...
save(route_all, file = "route_Omagh_all.Rda")
